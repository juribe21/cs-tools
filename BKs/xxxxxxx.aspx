<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Global/EnterprisePageTemplate.master" CodeBehind="EntAdminHome.aspx.vb" Inherits=".EntAdminHome" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ChildContent1" runat="server">
    ...
    <asp:Table runat="server" BorderWidth="0" Width="100%" CellPadding="0" CellSpacing="0">
        <asp:TableRow Visible="false">
            ...
            <asp:TableCell>
                                                <input type="radio" name="CustomerRadio" id="RadioSapCustomer" value="SA" checked="checked"/> Customer Account
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow BackColor="#738FBF">
            ...
            <asp:TableCell HorizontalAlign="Right" VerticalAlign="Middle" CssClass="HeaderSub1">
                <asp:TextBox ID="RxSearchBox" BorderWidth="1" BorderStyle="Inset" Height="14px" runat="server"></asp:TextBox>
                <asp:RegularExpressionValidator ID="Validator1" ASPClass="RegularExpressionValidator" ControlToValidate="RxSearchBox" ValidationExpression="[0-9]{2,}" runat="server"></asp:RegularExpressionValidator>
                <asp:Button ID="SearchButton" OnClick="SearchButton_Click" Text="Find Rx" CssClass="ButtonText" runat="server" />
            </asp:TableCell>
            <asp:TableCell HorizontalAlign="Right" VerticalAlign="Middle" CssClass="header" Width="5px">
                &nbsp;
            </asp:TableCell>
            ...
            <asp:TableCell ColumnSpan="4">
                <asp:Table runat="server">
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell>
                            <asp:GridView ID="GridView1" runat="server" Width="350" CellPadding="2" CssClass="WipGrid-View" EmptyDataText="<BR><BR>There are No Active Jobs In This Lab"
                                ...
                                <Columns>
                                    <asp:BoundField ReadOnly="true" HeaderText="Shipping Carrier" DataField="CarrierName" ItemStyle-HorizontalAlign="left"></asp:BoundField>
                                    <asp:TemplateField HeaderText="Start Time">
                                        <ItemTemplate>
                                            <asp:Label ID="lblStartTime" Text='<%# GlobalFunctionsClass.FormatTimeString(Eval("CarrierStartTime")) %>' runat="server" ItemStyle-HorizontalAlign="center"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Cutoff Time">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCutoffTime" Text='<%# GlobalFunctionsClass.FormatTimeString(Eval("CarrierCutoffTime")) %>' runat="server" ItemStyle-HorizontalAlign="center"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                    ...
                    <asp:TableRow>
                        <asp:TableCell HorizontalAlign="Center">
                            <asp:Table runat="server" CellPadding="4" CellSpacing="0" Width="340px" CssClass="OrderDetail" BorderWidth="1" BorderStyle="Solid" BorderColor="#0D5692">
                                <asp:TableRow BackColor="#0D5692" BorderWidth="1" BorderStyle="Solid" BorderColor="#0D5692">
                                    <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" ColumnSpan="4" ForeColor="White" Font-Bold="true">
                                ...
                                <asp:TableRow BackColor="#ffffff">
                                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="4">
                                        <asp:Table runat="server" BorderWidth="0">
                                            <asp:TableRow>
                                                <asp:TableCell runat="server" ID="TableCell1" HorizontalAlign="Left" VerticalAlign="Middle" CssClass="Text3">
                                                LabId:
                                                </asp:TableCell>
                                                <asp:TableCell VerticalAlign="Middle">
                                                    <input type="text" class="Customer" id="labIdInput" name="labIdInput"/>
                                                    <input type="button" value="Lookup" class="ButtonText" onclick="goToLabIdConfigMaintenance()" />
                                                </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </asp:TableCell>
                            ...
                            <asp:Table runat="server" CellPadding="4" CellSpacing="0" Width="340px" CssClass="OrderDetail" BorderWidth="1" BorderStyle="Solid" BorderColor="#0D5692">
                                ...
                                <asp:TableRow BackColor="#ffffff">
                                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="4">
                                        <asp:Table runat="server" BorderWidth="0">
                                            <asp:TableRow>
                                                <%--<asp:TableCell runat="server" ID="TableCell2" HorizontalAlign="Left" VerticalAlign="Middle" CssClass="Text3">
                                                    RxPortal:
                                                </asp:TableCell>--%>
                                                <asp:TableCell VerticalAlign="Middle">
                                                    <%--<input type="text" class="Customer" id="RxPortalInput" name="labIdInput"/>--%>
                                                    <input type="button" value="Load RxPortal Config" class="ButtonText" onclick="goToRxPortalEnterpriseConfig()" />
                                                </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </asp:TableCell>
                            ...
                            <asp:Table runat="server" CellPadding="4" CellSpacing="0" Width="340px" CssClass="OrderDetail" BorderWidth="1" BorderStyle="Solid" BorderColor="#0D5692">
                                ...
                                <asp:TableRow BackColor="#B1CDB1">
                                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="4">
                                        <asp:Table runat="server" BorderWidth="0">
                                            <asp:TableRow>
                                                <asp:TableCell runat="server" ID="TableCell3" HorizontalAlign="Left" VerticalAlign="Middle" CssClass="Text3">
                                                                    Account:
                                                </asp:TableCell>
                                                <asp:TableCell VerticalAlign="Middle">
                                                         <input type="text" class="Customer" id="CustomerInput" name="CustomerInput"/>

                                                    <input type="button" value="Lookup" class="ButtonText" onclick="goToAccountMaintenance()" />
                                                </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </asp:TableCell>
